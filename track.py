...
# To run this python 3.7 is required
# cv2 must be installed by pip install opencv-python
# pip install opencv-contrib-python
#resources    https://www.youtube.com/watch?v=1FJWXOO1SRI
#  https://ehsangazar.com/object-tracking-with-opencv-fd18ccdd7369

import cv2

############### Tracker Types #####################
# you can experiment with all of these
